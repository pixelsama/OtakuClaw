...
function normalizeNanobotConfig(settings = {}) {
  ...
  return {
    ...
    provider: normalizeString(aiModel.provider, 'openrouter'),
    model: normalizeString(aiModel.model, 'anthropic/claude-opus-4-5'),
    apiBase: normalizeString(aiModel.apiBase, ''),
    apiKey: normalizeString(aiModel.apiKey, ''),
